...
- set configuration.nix hostName and create a user (all the files assume user nexar and hostName NEXAR)
...
- cd ~
- git clone -b nexar-pc https://github.com/Tomasz-Badura/NixOs.git
- sudo mkdir /config
